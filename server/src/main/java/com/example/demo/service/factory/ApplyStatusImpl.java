...
@NoArgsConstructor
@Service
public class ApplyStatusImpl implements  ApplyStatusStrategy{
    @Autowired
    ...
    public String getForTeacherMessage(ApplyType applyType, String name,String teacherName,String vacanciesName) {
        ...
        message = message +",應徵的實習職缺"+ vacanciesName+"通知他去實習,詳細情況公司會跟您確認";
        return message;
    }
    ...
    public String getForStudentMessage(ApplyType applyType, String name, String vacanciesName) {
        ...
        message = message + name;
        message = message +",您應徵的實習職缺"+ vacanciesName+"通知您去實習,詳細情況公司會跟您確認";
        return message;
    }
}
