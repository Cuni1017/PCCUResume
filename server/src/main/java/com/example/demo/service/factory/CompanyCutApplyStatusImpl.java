...
public class CompanyCutApplyStatusImpl implements ApplyStatusStrategy {
    @Autowired
    ...
    public String getForTeacherMessage(ApplyType applyType, String name, String teacherName, String vacanciesName) {
        ...
        message = message +",應徵的實習職缺"+ vacanciesName+"中斷與他的實習合作,詳細情況公司會跟您確認";
        return message;
    }
    ...
    public String getForStudentMessage(ApplyType applyType, String name, String vacanciesName) {
        ...
        message = message + name;
        message = message +",您實習中的實習職缺"+ vacanciesName+"中斷與您的實習合作,詳細情況公司會跟您確認";
        return message;
    }
}
