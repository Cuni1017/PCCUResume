...
public class FileInterviewApplyStatusImpl implements ApplyStatusStrategy {
    @Autowired
    ...
    public String getForTeacherMessage(ApplyType applyType, String name, String teacherName, String vacanciesName) {
        ...
        message = message +",面試的實習職缺"+ vacanciesName+"失敗,詳細情況公司會跟您確認";
        return message;
    }
    ...
    public String getForStudentMessage(ApplyType applyType, String name, String vacanciesName) {
        ...
        message = message + name;
        message = message +",您面試中的實習職缺"+ vacanciesName+"失敗,詳細情況公司會跟您確認";
        return message;
    }
}
